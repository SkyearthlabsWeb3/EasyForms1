...
// Vipin
  // const runFunctionVipin = (responses) => {
  //   console.log("Entered Run Function-->", responses)
  //   let customResponse=[];
  //     const fetchdataFilled = async(key) => {
  //       console.log("Key runfunction:", key)
  ...
  //       .then((response) => {
  //         // console.log("Response from api ->",response.data.formResponses);
  //         // customResponse.push(response.data.formResponses)
  //         // setFinalSetOfResponse(...finalSetOfResponse, response.data.formResponses);
  //       })
  //       .catch((error) => {
  //         console.log(error);
  ...
  //     console.log("Responses.length ->", responses?.length);
  //     for (let i = 0; i < responses.length; i++) 
  //       customResponse.push(`${responses[i].key}/test1.json`)
  //       //fetchdataFilled(responses[i].key);
      

  //     Promises.all(idx=>fetch(idx)).then(responses=>
  //       Promises.all(responses.map(res=>res.data.formResponses)).then(res=>
          
  //         setFinalSetOfResponse(res.json()))
  //       )
